  ...
  switch ( kbWhere ) {
    ...
    case "previousStart": case "previousEnd":
      ...
      if ( parentSymbol?.children.length &&
        ...
        visitAllSymbols( parentSymbol.children.sort( compareRangesReverse ), compareRangesReverse, symbol => {
      ...
      for await ( let previousSymbol of reversedGlobalSymbols ) {
        ...
        if ( !previousSymbol.children.length ) {
          ...
          visitAllSymbols( previousSymbol.children.sort( compareRangesReverse ), compareRangesReverse, symbol => {
